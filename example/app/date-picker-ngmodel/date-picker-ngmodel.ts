...
import {
  ...
  IMyRangeDateSelection, TH
} from '../../../projects/angular-mydatepicker/src/public-api';
...
export class DatePickerNgmodel implements OnInit {
  ...
  public myJalaliDatePickerOptions: IAngularMyDpOptions = this.config.getDefaultConfig(CalendarType.Jalali);
  public myGregorianDatePickerOptions: IAngularMyDpOptions = this.config.getDefaultConfig(CalendarType.Gregorian);

  public jalaliCalendar: CalendarType = CalendarType.Jalali;
  public gregorianCalendar: CalendarType = CalendarType.Gregorian;
  ...
  @ViewChild('mydate') dateInput: HTMLInputElement;
  ...
  public calendar: CalendarType = CalendarType.Jalali;

  public calendars: Array<CalendarType> = [
    CalendarType.Gregorian,
    CalendarType.Jalali
  ];
  constructor(private config: DefaultConfigService) {}
  ...
  onChangeCalendar(calendar: CalendarType) {
...
*/
  ...
  changeToJalali(): void {
    this.onChangeCalendar(CalendarType.Jalali);
    this.locale = "fa";
    this.calendar = this.jalaliCalendar;
    this.ngxdp.calendar = this.jalaliCalendar;
    this.ngxdp.locale = "fa";
    this.ngxdp.changeOptions(this.myJalaliDatePickerOptions);
  }

  changeToGregorian(): void {
    this.onChangeCalendar(CalendarType.Gregorian);
    this.locale = "en";
    this.calendar = this.gregorianCalendar;
    this.ngxdp.calendar = this.gregorianCalendar;
    this.ngxdp.locale = "en";
    this.ngxdp.changeOptions(this.myGregorianDatePickerOptions);
  }
}
